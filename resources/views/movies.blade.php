    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
      <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6 text-gray-900 dark:text-gray-100">
          ...
          <h1 class="head">
            <nobr>Немцы <span class="text-blue-500">/ Die Deutschen</span></nobr>
          </h1>
          <p class="p-0 m-0 text-left"><b>Впервые на русском языке</b></p>
        </div>

        <div class="box-right">
          <nobr>Перейти на <a class="acont-top" href="http://diedeutschen.zdf.de/">официальную страницу</a> <span
              class="text-blue-500">(нем.)</span></nobr><br>
          <nobr>Материалы для <a class="acont-top"
            ...
            <span class="text-blue-500">(нем.)</span></nobr><br>
          <nobr>Сериал на сайте <a class="acont-top" href="http://www.kinopoisk.ru/film/654570/">Kinopoisk</a> и <a
              class="acont-top" href="http://www.imdb.com/title/tt1236350/">IMDb</a></nobr><br>
          <nobr>Связаться с <a class="acont-top" href="https://vk.com/diedeutschen">переводчиком</a></nobr><br>
        </div>
        <p>Сериал произведен Вторым каналом немецкого телевидения (<a class="acont-top"
            href="https://www.zdf.de/">ZDF</a>) и впервые публикуется на русском языке. Перевод доступен в двух
          вариантах: закадровое озвучание или субтитры специально для изучающих немецкий язык. Перевод этого сериала —
          любительский некоммерческий проект. Озвучание частично сделано на пожертвования зрителей Ютуб-канала&nbsp;<a
            class="acont-top" href="https://www.youtube.com/user/igakuz">igakuz</a>.</p>
